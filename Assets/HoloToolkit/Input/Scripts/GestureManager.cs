...
public class GestureManager : Singleton<GestureManager>
{
    ...
    void Awake()
    {
        ...
        //NavigationRecognizer.SetRecognizableGestures(GestureSettings.Tap | GestureSettings.NavigationX | GestureSettings.DoubleTap);
    ...
    private void NavigationRecognizer_NavigationStartedEvent1(InteractionSourceKind source, Vector3 normalizedOffset, Ray headRay)
    {
