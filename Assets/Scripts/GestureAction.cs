...
public class GestureAction : MonoBehaviour
{
    ...
    private void PerformRotation()
    {
            ...
            (ExpandModel.Instance.IsModelExpanded && HandsManager.Instance.FocusedGameObject == gameObject)))
        {
            ...
            // Why it has to times -1? Because otherwise it would rotate the opposite direction from your hand movement
    ...
    // I assume the position here means your hand position
